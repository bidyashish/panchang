...
swisseph.swe_julday(date.year, date.month, date.day, date.hour, swisseph.SE_GREG_CAL, function (julday_ut) {
    ...
    // Get ayanamsa
    swisseph.swe_get_ayanamsa_ut(julday_ut, function(result) {
    ...
    swisseph.swe_calc_ut(julday_ut, swisseph.SE_SUN, flag, function (body) {
        ...
        // Convert to sidereal
        swisseph.swe_get_ayanamsa_ut(julday_ut, function(ayanamsa_result) {
    ...
    // Calculate sunrise
    swisseph.swe_rise_trans(julday_ut - 0.5, swisseph.SE_SUN, null, 0, swisseph.SE_CALC_RISE, [lon, lat, alt], 0, 0, function(result) {
        if (!result.error) {
    ...
    // Calculate sunset
    swisseph.swe_rise_trans(julday_ut - 0.5, swisseph.SE_SUN, null, 0, swisseph.SE_CALC_SET, [lon, lat, alt], 0, 0, function(result) {
        if (!result.error) {
